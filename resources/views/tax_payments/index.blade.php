        ...
        <div class="p-4 bg-gray-50/50 border-b border-gray-100 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto justify-end sm:justify-start">
                    <button @click="window.exportToExcel(filteredPayments, ['payment_date', 'tax_name', 'reference_number', 'currency', 'amount'], ['Fecha de Pago', 'Concepto Alícuota', 'Número Referencia', 'Moneda', 'Monto Abonado'], 'Impuestos_SolucionesDelAgua')"
                            type="button"
                    ...
                    <button @click="window.exportToPDF(filteredPayments, ['payment_date', 'tax_name', 'reference_number', 'currency', 'amount'], ['Fecha de Pago', 'Concepto Alícuota', 'Número Referencia', 'Moneda', 'Monto Abonado'], 'Reporte de Impuestos y Tasas SENIAT')"
                            type="button"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2.5 py-1.5 rounded-md text-[10px] font-bold border inline-flex items-center gap-1.5"
                                      :class="p.currency === 'USD' ? 'bg-emerald-50 text-emerald-700 border-emerald-200/60' : 'bg-sky-50 text-sky-700 border-sky-200/60'">
                                    <i class="fa-solid" :class="p.currency === 'USD' ? 'fa-dollar-sign' : 'fa-coins'"></i>
                                    <span x-text="p.currency"></span>
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right font-mono">
                                <span class="px-2.5 py-1 rounded-md text-[11px] font-bold border inline-block min-w-[70px] text-center"
                                      :class="p.currency === 'USD' ? 'bg-emerald-50 text-emerald-700 border-emerald-200/60' : 'bg-sky-50 text-sky-700 border-sky-200/60'"
                                      x-text="(p.currency === 'USD' ? '$' : 'Bs.') + parseFloat(p.amount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })">
                                </span>
                            </td>
